...
sp("\nEnter your email made by Gaurav :\n")
...
sp("\nEnter your password made by Gaurav:\n")
...
sp("Enter chat group or inbox id link made by Gaurav :\n")
...
sp("Enter notepad file name made By Gaurav:")
